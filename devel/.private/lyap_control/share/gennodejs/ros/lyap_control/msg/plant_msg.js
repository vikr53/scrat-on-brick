...
class plant_msg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('setpoint')) {
        ...
        this.setpoint = new Array(3).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.setpoint.length !== 3) {
      throw new Error('Unable to serialize array field setpoint - length must be 3')
    }
    // Serialize message field [setpoint]
    bufferOffset = _arraySerializer.float64(obj.setpoint, buffer, bufferOffset, 3);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.setpoint = _arrayDeserializer.float64(buffer, bufferOffset, 3)
    return data;
  }
  ...
  static datatype() {
    ...
    return 'lyap_control/plant_msg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b0f1b97d00071f8e5c4d2c83353c47d2';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.setpoint !== undefined) {
      ...
      resolved.setpoint = new Array(3).fill(0)
    }
