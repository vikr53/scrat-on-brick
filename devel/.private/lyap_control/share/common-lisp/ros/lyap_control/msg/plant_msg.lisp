...
(cl:defmethod cl:initialize-instance :after ((m <plant_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'plant_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lyap_control-msg:<plant_msg> is deprecated: use lyap_control-msg:plant_msg instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <plant_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lyap_control-msg:x-val is deprecated.  Use lyap_control-msg:x instead.")
  (x m))

(cl:ensure-generic-function 't-val :lambda-list '(m))
(cl:defmethod t-val ((m <plant_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lyap_control-msg:t-val is deprecated.  Use lyap_control-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'setpoint-val :lambda-list '(m))
(cl:defmethod setpoint-val ((m <plant_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lyap_control-msg:setpoint-val is deprecated.  Use lyap_control-msg:setpoint instead.")
  (setpoint m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <plant_msg>) istream)
  ...
  (cl:setf (cl:slot-value msg 'setpoint) (cl:make-array 3))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<plant_msg>)))
  ...
  "b0f1b97d00071f8e5c4d2c83353c47d2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'plant_msg)))
  "Returns md5sum for a message object of type 'plant_msg"
  "b0f1b97d00071f8e5c4d2c83353c47d2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<plant_msg>)))
  ...
  (cl:format cl:nil "float64[3] x~%float64 t~%float64[3] setpoint~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'plant_msg)))
  "Returns full string definition for message of type 'plant_msg"
  (cl:format cl:nil "float64[3] x~%float64 t~%float64[3] setpoint~%~%~%"))
