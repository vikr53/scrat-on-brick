...
(cl:defmethod cl:initialize-instance :after ((m <controller_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'controller_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fbl_control-msg:<controller_msg> is deprecated: use fbl_control-msg:controller_msg instead.")))

(cl:ensure-generic-function 'u-val :lambda-list '(m))
(cl:defmethod u-val ((m <controller_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fbl_control-msg:u-val is deprecated.  Use fbl_control-msg:u instead.")
  (u m))
